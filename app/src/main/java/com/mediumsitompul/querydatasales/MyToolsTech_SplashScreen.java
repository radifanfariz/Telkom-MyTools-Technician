...
public class MyToolsTech_SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mytools_tech_splashscreen);

        if (checkLocationPermission()) {
            startActivity(new Intent(MyToolsTech_SplashScreen.this, Login2.class));
            finish();
        }
    }
