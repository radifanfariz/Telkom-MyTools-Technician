...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Permission
        permission_access_first = new Permission_Access_First(getApplicationContext(),Login.this);
    ...
    private class Dologin extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(isSuccess) {
                ...
                Intent intent=new Intent(Login.this,DataSales_Search.class); //xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
